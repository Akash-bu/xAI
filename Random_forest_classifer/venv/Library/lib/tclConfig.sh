...
# installed.
TCL_PREFIX='D:/xAI/Random_forest_classifer/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/xAI/Random_forest_classifer/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/xAI/Random_forest_classifer/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/xAI/Random_forest_classifer/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/xAI/Random_forest_classifer/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/xAI/Random_forest_classifer/venv\Library\lib\tclstub86.lib'
